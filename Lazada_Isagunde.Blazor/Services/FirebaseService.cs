...
{
    private const string FirebaseBaseUrl = "https://isagunde-lazada-default-rtdb.asia-southeast1.firebasedatabase.app/";
    ...
    public FirebaseService(AuthService authService)
    {
        ...
        {
            AuthTokenAsyncFactory = () => _authService.GetFreshTokenAsync()
        });
    }
